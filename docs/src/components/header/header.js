...
<aside class="sidebar">
  ...
  <ul class="links">
    <li>
      <a href="start.html">
        <img src="../assets/exit-to-app-svgrepo-com.svg" alt="Log out" width="30" height="25" id="log-out-icon"> Log out
      </a>
    </li>

    <li>
      <a href="ranking.html">
        <img src="../assets/star-svgrepo-com.svg" alt="Ranking" width="30" height="25" id="ranking-icon"> Ranking
      </a>
    </li>
  </ul>
</aside>
